...
//         <>
//             {/* Sales Team 1 */}
//             {Object.keys(firstHighestTeam).length > 0 ? (
//                 <div className="">
//                     <h2
...
//                                         ৳ {firstHighestTeam?.total_sales}
//                                     </td>

//                                     <td className="text-center">
//                                         {firstHighestTeam?.affiliate_user
//                                             ?.refer_count || 0}
//                                     </td>
//                                     <td className="text-center">
//                                         {firstHighestTeam?.affiliate_user
...
//                 </div>
//             ):(
//                 <NoDataFound title="Sales Team One Not Found" />
//             )}

//             {/* Sales Team 2 */}
//             {Object.keys(secondHighestTeam).length > 0 ? (
//                 <div className="">
//                     <h2
//                         className="fs-5 border-bottom py-1 text-white ps-2"
//                         style={{ background: "#44bc9d" }}
...
//                                     <td className="text-end">
//                                         ৳ {secondHighestTeam?.total_sales}
//                                     </td>

//                                     <td className="text-center">
//                                         {secondHighestTeam?.affiliate_user
//                                             ?.refer_count || 0}
//                                     </td>
//                                     <td className="text-center">
//                                         {secondHighestTeam?.affiliate_user
...
//                 </div>
//             ):(
//                 <NoDataFound title="Sales Team Two Not Found" />
//             )}
...
//                 </div>
//             ):(
//                 <NoDataFound title="Sales Team Others Not Found" />
//             )}
//         </>
//     );
// };
